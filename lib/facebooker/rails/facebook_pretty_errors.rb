class ActionController::Base
  ...
  alias_method_chain :rescues_path, :facebooker if Facebooker.facebooker_config['pretty_errors'] || (Facebooker.facebooker_config['pretty_errors'].nil? && RAILS_ENV=="development")
